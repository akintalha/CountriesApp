...
var staticFilesPath = path.join(__dirname, 'wwwroot');
...
app.get('/countries', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, client.query({
                        query: (0, client_1.gql)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n        query GetCountries {\n          countries {\n            name\n            code\n            capital\n            emoji\n            continent {\n                name\n                code\n              }\n          }\n        }\n      "], ["\n        query GetCountries {\n          countries {\n            name\n            code\n            capital\n            emoji\n            continent {\n                name\n                code\n              }\n          }\n        }\n      "]))),
                    })];
            case 1:
                data = (_a.sent()).data;
